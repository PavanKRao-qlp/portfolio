...
import GithubCard from "../../components/GitHubCard.astro"
  ...
  ### Physics & Collision
  - Rigid body simulation with broad-phase (`BruteForceBroadphaseResolver`) and narrow-phase collision
  - `PhysicsService` + `RigidbodyHandleComponent` bridge — physics owns simulation, ECS owns data
  - Collision callbacks via `CollisionEventResolverSystem`
