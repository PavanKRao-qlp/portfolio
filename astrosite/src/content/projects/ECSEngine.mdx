...
heroImage: "/umbra.jpg"
highlights:
  - "Custom <strong>C++</strong> 2D engine: bitset <strong>ECS</strong>, multithreaded job system, physics, audio, asset pipeline"
  - "Sequential-impulse collision solver with a dynamic <strong>AABB-tree</strong> broadphase"
  - "Work-stealing <strong>M:N job system</strong> with <strong>ParallelFor</strong> and dependency chains"
priority: -2
pin: true
---
